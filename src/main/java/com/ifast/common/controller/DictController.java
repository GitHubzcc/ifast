...
public class DictController extends AdminBaseController {
    ...
    String sysDict() {
        System.out.println(getSubjct().toString()+"----getSubjct+++++++++++++++++++++");
        System.out.println(getSubjct().getPrincipals()+"----getSubjct+++++++++++++++++++++");
        if(getSubjct().isPermitted("common:sysDict:sysDict")){
            System.out.println(getSubjct().getPrincipal()+"-------getPrincipal----进来了-----");
            System.out.println(getSubjct().getPreviousPrincipals()+"-------getPreviousPrincipals----进来了-----");
        }
        System.out.println("------sysdict-------1--");
